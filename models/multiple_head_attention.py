...
Step 3: Adding Multiple Attention Heads

This model introduces multiple attention heads working in parallel.
Key addition: Multiple heads can focus on different types of relationships.
"""
...
class MultiHeadAttentionModel(nn.Module):
    """Language model with multi-head self-attention"""
...
def train_model():
    ...
    print("Key innovation: Multiple attention heads in parallel")
    print(f"- {n_head} attention heads working simultaneously")
    print("- Each head can learn different types of relationships")
    print("- Projection layer combines all heads' outputs")
    print("- Dropout added for regularization\n")
